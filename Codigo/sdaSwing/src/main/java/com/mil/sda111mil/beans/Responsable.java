...
public class Responsable extends Persona implements Serializable{
    ...
    public Responsable(List<Telefono> telefonos, List<Alumno> aCargo, String nombre, String apellido, int dni, String direccion, int telefono, String email, Date fechaNacimiento, String sexo) {
