...
public class Alumno extends Persona implements Serializable {
    ...
    public Alumno(List<Asistencia> asistencia, String padreMadreTutor, Curso curso, Responsable responsable, String nombre, String apellido, int dni, String direccion, String email, Date fechaNacimiento) {
    ...
    // Corregi sintaxis de la salida de datos de Curso:B a Curso 1ºB
    @Override
    public String toString() {
        return super.toString()
                + " - Responsable: " + this.getResponsable().getNombre()
     ...
     */
    public double getAsistenciasTotales() {
